    ...
    <main className="mx-auto grid min-h-[65vh] w-full max-w-7xl place-items-center px-4 py-16 sm:px-6 lg:px-8">
      <section className="max-w-2xl text-center">
        ...
        <div className="mt-7 flex flex-col justify-center gap-3 sm:flex-row">
          <Link
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-[#1B1712] px-5 text-xs font-bold text-white"
            href="/"
          >
          ...
          <Link
            className="inline-flex min-h-11 items-center justify-center gap-2 rounded-xl border border-slate-300 bg-white px-5 text-xs font-bold text-[#1B1712]"
            href="/arxiv"
          >
