  ...
  return (
    <main className="mx-auto w-full max-w-7xl px-4 py-10 sm:px-6 sm:py-14 lg:px-8">
      <header className="mb-9 max-w-3xl">
        ...
        <h1 className="mt-3 font-serif text-4xl font-black tracking-tight text-[#1E4468] sm:text-5xl">
          {heading}
        </h1>
      ...
      {articles.length > 0 ? (
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-12 text-center shadow-sm">
          ...
          <Link
            className="mt-5 inline-flex min-h-11 items-center justify-center gap-2 rounded-xl bg-[#1E4468] px-5 text-xs font-bold text-white"
            href="/arxiv"
          >
